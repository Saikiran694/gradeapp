...
public class MainUser {
	...
	public final void setExpDate(String expDate) {
	...
	public final void setOldUserName(String oldUserName) {
	...
	public final void setNewPass(String newPass) {
	...
	public final void setConfirmPass(String confirmPass) {
