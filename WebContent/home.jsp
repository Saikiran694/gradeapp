  ...
  <header>
    ...
    <form name="linkForm" method="post">
           <input type="hidden"  class="input"  name="viewType" value=""/>
                <ul id="menu">
		  <li    id="menu_active"><a href="#" onClick="performAction('home');"><span><span>Enroll Courses</span></span></a></li>
...
<!-- 		  <li ><a href="#" onClick="performAction('services');"><span><span>Raise Tickets</span></span></a></li>
 ...
 <h3 class="pad_top1" align="center">Enroll Courses</h3>
       ...
       <input type="hidden"  class="input"  name="viewType" value="search"/>
        ...
        <tr><td colspan="8">&nbsp;</td></tr>
           ...
           <tr><td>&nbsp;</td></tr>
              ...
              <tr align="center"> <td>Department Name:</td>
        ...
        <td  align="center"><input type="submit" value="Filter Courses" /></td>
        </tr>
        <!-- <tr><td>&nbsp;</td></tr>
        ...
        <tr><td>&nbsp;</td></tr>
    <tr>
        <td colspan="7"> <h4>Available Courses</h4> </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
     <tr>
     <th>Course Name</th>
    ...
    <td><a href="#"  onClick="enrollCourse('<core:out value="${course.courseId}"/>');">Enroll Course</a></td>
    </tr>
