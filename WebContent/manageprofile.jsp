    ...
    <input type="hidden"  class="input"  name="viewType" value=""/>
		  ...
		  <li  ><a href="#" onClick="performAction('home');"><span><span>Enroll Courses</span></span></a></li>
		   <li><a href="#" onClick="performAction('managecourses');"><span><span>My Courses</span></span></a></li>
		    <li><a href="#" onClick="performAction('viewassignments');"><span><span>View Tasks</span></span></a></li>
...
<!-- 		  <li ><a href="#" onClick="performAction('services');"><span><span>Service Requests</span></span></a></li>
 -->        	<li   id="menu_active"><a href="#" onClick="performAction('viewprofile');"><span><span>Update Profile</span></span></a></li>
 ...
 <h3 class="pad_top1">Update Profile Form</h3>
        ...
        <tr>
        <td> User Name: </td>
        <td> <input type="text"  class="input"  name="username" disabled="true" value="${user1.userName}"/></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr> <td>Password:</td>
            <td> <input type="password" class="input" name="userpass" required="required" value="${user1.password}"/></td>
              </tr>
        ...
        <option value="4">What is the name of your best friend?</option>        
            ...
            <td> <input type="password" class="input" name="securityanswer" required="required" value="${user1.securityAnswer }"/></td>
              </tr>
              
              <tr><td>&nbsp;</td></tr>
               <tr>
        <td>  First Name: </td>
        <td> <input type="text"  class="input"  name="firstname" required="required" value="${user1.firstName }"/></td>
            </tr>
            
            <tr><td>&nbsp;</td></tr>
             <tr>
        <td>  Middle Name: </td>
        <td> <input type="text"  class="input"  name="middlename" required="required" value="${user1.middleName }"/></td>
            </tr>
            
            <tr><td>&nbsp;</td></tr>  
             <tr>
        <td>  Last Name: </td>
        <td> <input type="text"  class="input"  name="lastname" required="required" value="${user1.lastName }"/></td>
            </tr>
            
            <tr><td>&nbsp;</td></tr>
             <tr>
        <td>  Mobile Number: </td>
        <td> <input type="text"  class="input"  name="mobileno" required="required" value="${user1.contactNo }"/></td>
            </tr>
           
            <tr><td>&nbsp;</td></tr>
            <tr>
        <td>  Email Id: </td>
        <td> <input type="text"  class="input"  name="emailid" required="required" value="${user1.emailId }"/></td>
            </tr>
