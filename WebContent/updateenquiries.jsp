...
<div class="main">
    ...
    <nav>
        ...
        <li><a href="adddepartments.jsp"><span><span>Manage Courses</span></span></a></li>
        ...
        <li  id="menu_active"><a href="#" onClick="modifyFunction('enquiryhome');"><span><span>Track Tickets</span></span></a></li>
  ...
  <section id="content">
    <div class="wrapper pad1">
      ...
      <article class="col2">
        <h3 class="pad_top1" align="center">Update Ticket</h3>
       ...
       <div  class="wrapper"> <span>Status :</span>
        ...
        <br/>
         <div  align="center">   <input type="submit" value="Update Ticket" /> </div> </div>
        </form>
      </article>
    </div>
  </section>
