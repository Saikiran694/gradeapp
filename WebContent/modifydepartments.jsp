...
<div class="main">
  <header>
    ...
    function updatedepartment(departmentCode) {
    	document.ContactForm.viewType.value="editdepartmentdetails";
    	document.ContactForm.selecteddepartment.value=departmentCode;
    	document.ContactForm.submit();
    }
 ...
 -->                   </core:if>
      ...
      <article class="col2">
       <form id="ContactForm" name="ContactForm" action="viewDepartmentsServlet" method="post">
        <input type="hidden"  class="input"  name="viewType" required="required" value="editdepartment"/>
        <input type="hidden"  class="input"  name="selecteddepartment" required="required" value=""/>
 
       
        <core:if test="${user.userType=='admin'}">
 <h3 class="pad_top1" align="center">Edit Course Details</h3>
        <table align="center">
    ...
    <td><a href="#"  onClick="updatedepartment('<core:out value="${course.courseId}"/>');">Edit</a></td>
    ...
    <td><a href="#"  onClick="updatedepartment('<core:out value="${assign.updateId}"/>');">Edit</a></td>
